...
float runEM(const vector<float>& x, const vector<float>& y, double & a0,
		double & a1, double & a2, double & a3, int maximalNumberOfIterations,
		int ploidy, int maximalNumberOfCopies) {
	// @suppress("No return")
...
vector<int> merge_no_dups(const vector<int>& v1, const vector<int>& v2); // @suppress("Unused function declaration")
